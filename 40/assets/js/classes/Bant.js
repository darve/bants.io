...
var Bant = Class.extend({
	...
	init: function( position, velocity ){
		...
		this.radius = 5;
		// this.velocity.rotate(Math.random()*16-Math.random()*16);
	...
	draw: function() {
		...
		if ( (this.pos.x > FUNK.canvas.width) || (this.pos.y > FUNK.canvas.height) || (this.pos.x < -105) || (this.pos.y < -105) ) {
			this.dead = true;
		}
