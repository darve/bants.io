...
var FUNK = {
	...
	init: function(){
		...
		$(document).on('touchmove touchstart', 'canvas', function(event){
			...
			FUNK.bants.push( new Bant( FUNK.vector, new Vector2( 0, 0) ) );
		});
	...
	animate: function(){
		...
		if ( FUNK.framenum % 10 === 0 ) {
			// FUNK.bants.push( new Bant( new Vector2( FUNK.canvas.width/2, FUNK.canvas.height-10), new Vector2( 0, -6) ));	
		}
		...
		if ( FUNK.bants[0] ) FUNK.ctx.fillText( 'BANT VELOCITY: ' + FUNK.bants[0].velocity, 15, 40 );
