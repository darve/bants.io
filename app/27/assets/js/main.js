...
var FUNK = {
	...
	init: function(){
		...
		FUNK.controller = new Leap.Controller();

		FUNK.controller.on('connect', function() {
		  console.log("Successfully connected.");
		});

		FUNK.controller.on('deviceConnected', function() {
		  console.log("A Leap device has been connected.");
		});

		FUNK.controller.on('deviceDisconnected', function() {
		  console.log("A Leap device has been disconnected.");
		});

		FUNK.controller.connect();
	...
	animate: function(){
		...
		FUNK.bants.push( new Bant( new Vector2( FUNK.canvas.width/2, FUNK.canvas.height-100), new Vector2( 0, -10) ));	
