...
var FUNK = {
	...
	init: function(){
		...
		FUNK.vector = new Vector2( (FUNK.canvas.width/2), FUNK.canvas.height/2 );
		var spawn = new Vector2((FUNK.canvas.width/2), FUNK.canvas.height/2);
		...
		FUNK.verts.push( new Vert( new Vector2( 0, FUNK.canvas.height/2), new Vector2(FUNK.canvas.width/2,-FUNK.canvas.height/2) ) );
		FUNK.verts.push( new Vert( new Vector2( FUNK.canvas.width/2, 0), new Vector2(FUNK.canvas.width/2,FUNK.canvas.height/2) ) );
		FUNK.verts.push( new Vert( new Vector2( 0, FUNK.canvas.height/2), new Vector2(FUNK.canvas.width/2,FUNK.canvas.height/2) ) );
		FUNK.verts.push( new Vert( new Vector2( FUNK.canvas.width/2, FUNK.canvas.height), new Vector2(FUNK.canvas.width/2,-FUNK.canvas.height/2) ) );
